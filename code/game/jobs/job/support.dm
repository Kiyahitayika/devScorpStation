...
/datum/job/bartender
	...
	department_access = list(ACCESS_BAR, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_GATEWAY, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_KITCHEN, ACCESS_LIBRARY, ACCESS_MINT, ACCESS_MORGUE, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE, ACCESS_WAITER, ACCESS_WEAPONS)
...
/datum/job/bouncer
	...
	department_head = list("Head of Personnel")
	selection_color = "#dddddd"
	department_access = list(ACCESS_BAR, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_GATEWAY, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_KITCHEN, ACCESS_LIBRARY, ACCESS_MINERAL_STOREROOM, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MINT, ACCESS_MORGUE, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE, ACCESS_WAITER, ACCESS_WEAPONS)
	access = list(ACCESS_HYDROPONICS, ACCESS_BAR, ACCESS_KITCHEN, ACCESS_MORGUE, ACCESS_WEAPONS, ACCESS_MINERAL_STOREROOM, ACCESS_WAITER, ACCESS_MAINT_TUNNELS)
...
/datum/job/waiter
	...
	department_head = list("Head of Personnel")
	selection_color = "#dddddd"
	department_access = list(ACCESS_BAR, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_GATEWAY, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_KITCHEN, ACCESS_LIBRARY, ACCESS_MINERAL_STOREROOM, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MINT, ACCESS_MORGUE, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_THEATRE, ACCESS_WAITER)
	access = list(ACCESS_HYDROPONICS, ACCESS_BAR, ACCESS_KITCHEN, ACCESS_MORGUE, ACCESS_WEAPONS, ACCESS_MINERAL_STOREROOM, ACCESS_WAITER, ACCESS_MAINT_TUNNELS)
	minimal_access = list(ACCESS_BAR, ACCESS_MAINT_TUNNELS, ACCESS_WEAPONS, ACCESS_MINERAL_STOREROOM, ACCESS_WAITER)
...
/datum/job/qm
	...
	department_head = list("Head of Personnel")
	selection_color = "#dddddd"
	department_access = list(ACCESS_BAR, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_GATEWAY, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_KITCHEN, ACCESS_LIBRARY, ACCESS_MINERAL_STOREROOM, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MINT, ACCESS_MORGUE, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_QM, ACCESS_THEATRE, ACCESS_WAITER, ACCESS_WEAPONS)
...
/datum/job/clown
	...
	department_head = list("Head of Personnel")
	selection_color = "#dddddd"
	department_access = list(ACCESS_BAR, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_CLOWN, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_GATEWAY, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_KITCHEN, ACCESS_LIBRARY, ACCESS_MINERAL_STOREROOM, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MINT, ACCESS_MORGUE, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_MIME, ACCESS_THEATRE, ACCESS_WAITER)
...
/datum/job/arksoftinstructor
	...
	department_access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_FORENSICS_LOCKERS,
